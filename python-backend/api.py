...
def _build_agents_list() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        make_agent_dict(blog_agent),
        make_agent_dict(form_agent),
        make_agent_dict(order_agent),
        make_agent_dict(product_agent),
    ]
...
async def chat_endpoint(req: ChatRequest):
    ...
    for item in result.new_items:
        ...
        # Handle handoff output and agent switching
            ...
            # elif tool_name == "blog_search_tool":
            #     messages.append(
            #         MessageResponse(
            #             content="BLOG_SEARCH_RESULT",
            #             agent=item.agent.name,
            #         )
            #     )
